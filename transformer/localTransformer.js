/*
 * Add feature to localFeatureConfig file
 */ 
const add = (fileInfo, api, {featureName, localFeatureName, enableValue}) => {
    console.log(`Add feature to localFeatureConfig file: ${featureName}, ${localFeatureName}, ${enableValue}`);
...
const remove = (fileInfo, api) => {
    console.log('Remove feature to localFeatureConfig file');
    return api.jscodeshift(fileInfo.source).toSource();
};
...
const toggle = (fileInfo, api, featureName, enableValue) => {
    console.log('Toggling feature to localFeatureConfig file ' + featureName + ', enableValue = ' + enableValue);
    return api.jscodeshift(fileInfo.source).toSource();
}; 
